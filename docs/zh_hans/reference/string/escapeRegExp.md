...
```typescript
import { escapeRegExp } from '@fanslar/es-toolkit/string'
...
const content = 'Visit our site at https://fanslar.github.io/es-toolkit/ for more info'
matchesUrl(content, 'https://fanslar.github.io/es-toolkit/') // returns true
```
