...
```typescript
import { isEqualWith } from '@fanslar/es-toolkit/predicate'
...
// 允许浮点数误差的比较
function approximateCompare(a, b) {
...
// 忽略特定属性的比较
function ignoreTimestamp(a, b, property) {
...
function areValuesEqual(a, b, property) {
  // 忽略 ID
  if (property === 'id') {
    return true
  }
