description: "@fanslar/es-toolkit 提供的最小包体积"
---

# 包体积

![图表显示 @fanslar/es-toolkit 与 lodash 之间包大小的差异，差异高达97%。](https://es-toolkit.dev/assets/bundle-size.png)

通过其现代化的实现，@fanslar/es-toolkit 显著减少了其包体积，与 [lodash](https://lodash.com) 等其他库相比，可以减少高达97%。

这使得 @fanslar/es-toolkit 在包体积方面成为最高效的选择，其中一些实用函数的体积甚至少于100字节。
...
```tsx
import { chunk } from '@fanslar/es-toolkit'
...
有关详细信息，请参见我们的[包体积基准代码](https://github.com/fanslar/es-toolkit/tree/main/benchmarks/bundle-size)。
