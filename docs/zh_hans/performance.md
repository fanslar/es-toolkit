---
description: "@fanslar/es-toolkit 与替代库之间的性能差异"
---

# 性能

![图表显示 @fanslar/es-toolkit 与 lodash 之间性能差异。使用 @fanslar/es-toolkit 可获得高达11倍的性能提升。](https://es-toolkit.dev/assets/performance.png)

@fanslar/es-toolkit 设计时考虑了性能，与类似 lodash 的替代库相比，平均性能提升了2倍。通过充分利用现代 JavaScript API，部分函数甚至可以获得高达11倍的性能提升。
...
在 MacBook Pro 14-inch (M1 Max, 2021) 上进行了测试。请参考我们的 [基准测试代码](https://github.com/fanslar/es-toolkit/tree/main/benchmarks)。
