...
![Graph showing the difference in bundle size between es-toolkit and lodash. There is a difference up to 97% in bundle size.](https://es-toolkit.dev/assets/bundle-size.png)
