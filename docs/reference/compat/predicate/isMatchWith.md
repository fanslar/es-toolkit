...
```typescript
import { isMatchWith } from '@fanslar/es-toolkit/compat'

// Case-insensitive string comparison
function caseInsensitiveCompare(objVal, srcVal) {
...
function rangeCompare(objVal, srcVal, key) {
...
function lengthCompare(objVal, srcVal, key) {
...
function conditionalCompare(objVal, srcVal, key, object, source) {
