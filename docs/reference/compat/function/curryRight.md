...
```typescript
import { curryRight } from '@fanslar/es-toolkit/compat'
...
```typescript
import { curry, curryRight } from '@fanslar/es-toolkit/compat'
...
import { curryRight } from '@fanslar/es-toolkit'
...
curriedCompat(1)(curryRight.placeholder, 3)(2)
