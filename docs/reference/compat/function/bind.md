...
```typescript
import { bind } from '@fanslar/es-toolkit/compat'
...
const parseDecimal = bind(Number.parseInt, null, bind.placeholder, 10)
...
const problematic = ['1', '2', '3'].map(Number.parseInt) // [1, NaN, NaN]
```
