...
describe('toNumber', () => {
  ...
  it(`should convert number primitives and objects to numbers`, () => {
    const values = [2, 1.2, MAX_SAFE_INTEGER, MAX_INTEGER, Infinity, Number.NaN]
  ...
  it(`should convert string primitives and objects to numbers`, () => {
    ...
    const actual = values.map(value =>
      flatMap(transforms, mod => [toNumber(mod(value)), toNumber(new Object(mod(value)))]),
    )
  ...
  it(`should convert invalid binary/octal strings to 'NaN'`, () => {
    ...
    const expected = values.map(() => [Number.NaN, Number.NaN, Number.NaN, Number.NaN, Number.NaN, Number.NaN, Number.NaN, Number.NaN])
  ...
  it(`should coerce objects to numbers`, () => {
    ...
    const expected = [Number.NaN, 0, 1, Number.NaN, Number.NaN, 2.2, 1.1, 1.1, Number.NaN, Number.NaN, 5349, 5349, 42, 42]
