 ...
 * @example
 * // Clone an object
 * const obj = { a: 1, b: '@fanslar/es-toolkit', c: [1, 2, 3] };
 * const clonedObj = clone(obj);
 * console.log(clonedObj); // { a: 1, b: '@fanslar/es-toolkit', c: [1, 2, 3] }
...
export function clone<T>(obj: T): T {
  ...
  if (tag === symbolTag) {
    return new Object(Symbol.prototype.valueOf.call(obj)) as any
  }
