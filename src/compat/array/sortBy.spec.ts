...
describe('sortBy', () => {
  ...
  it('should move `NaN`, nullish, and symbol values to the end', () => {
    ...
    const array = [Number.NaN, undefined, null, 4, symbol1, null, 1, symbol2, undefined, 3, Number.NaN, 2]
    const expected = [1, 2, 3, 4, symbol1, symbol2, null, null, undefined, undefined, Number.NaN, Number.NaN]

    expect(sortBy(array)).toEqual(expected)
    expect(sortBy(array, [])).toEqual(expected)

    const array2 = [Number.NaN, undefined, symbol1, null, 'd', null, 'a', symbol2, undefined, 'c', Number.NaN, 'b']
    const expected2 = ['a', 'b', 'c', 'd', symbol1, symbol2, null, null, undefined, undefined, Number.NaN, Number.NaN]
