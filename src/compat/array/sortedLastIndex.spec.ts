...
describe('sortedLastIndex', () => {
  ...
  it(`should align with 'sortBy' for various data types`, () => {
    ...
    const expected = [1, '2', {}, symbol1, symbol2, null, undefined, Number.NaN, Number.NaN]

    const array1 = [Number.NaN, symbol1, null, 1, '2', {}, symbol2, Number.NaN, undefined]
    const array2 = ['2', null, 1, symbol1, Number.NaN, {}, Number.NaN, symbol2, undefined]
