import type { ValueIteratee } from '../_internal/ValueIteratee.ts'
 ...
 * @param {ValueIteratee<T>} [iteratee] - The iteratee to transform keys
 ...
 * @param {ValueIteratee<T[keyof T]>} [iteratee] - The iteratee to transform keys
