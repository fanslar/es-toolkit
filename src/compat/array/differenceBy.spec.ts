...
describe('differenceBy', () => {
  ...
  it('should provide correct iteratee arguments', () => {
    ...
    differenceBy([2.1, 1.2], [2.3, 3.4], (...rest: any[]) => {
      if (!args) {
  ...
  it(`should match \`NaN\``, () => {
    expect(differenceBy([1, Number.NaN, 3], [Number.NaN, 5, Number.NaN])).toEqual([1, 3])
  })
  ...
  it(`should work with large arrays of \`NaN\``, () => {
    const largeArray = Array.from({ length: LARGE_ARRAY_SIZE }).map(() => Number.NaN)
